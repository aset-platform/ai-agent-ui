...
const JOB_TYPES = [
  ...
  { value: "regime_classifier_daily",
    label: "Detect Market Regime" },
  { value: "regime_change_notifier",
    label: "Notify Regime Change" },
  { value: "compute_daily_factors",
    label: "Compute Daily Factors" },
  { value: "attribution_daily_brinson",
    label: "Daily Brinson Attribution" },
  { value: "universe_snapshot_monthly",
    label: "Refresh Top-200 Universe" },
  { value: "attribution_monthly_regression",
    label: "Run Factor Regression" },
